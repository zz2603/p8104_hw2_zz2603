...
## pol-month.csv
```{r}
polmonth <- read_csv("./data/pols-month.csv") %>% janitor::clean_names() %>%
...
### set a key variable
Since every dataset has variable year and month, we can merge three datasets by setting either year or month as key variable. We can also combine year and month together into variable date and set date as key variable.
```{r}
